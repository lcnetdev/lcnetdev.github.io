...
This RDF description created by the stylesheet at http://lcnetdev.github.io/standards/mods/modsrdf/xsl-files/modsrdf.xsl
...
-->
			<xsl:element name="elementList" namespace="http://lcnetdev.github.io/mads/rdf/v1#">
				...
				<!-- -->
					...
					<xsl:element name="authorityLink" namespace="http://lcnetdev.github.io/mods/rdf/v1#">
