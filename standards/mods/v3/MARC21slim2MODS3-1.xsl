...
-->
	<xsl:template match="/">
		<xsl:choose>
			...
			<xsl:otherwise>
				<mods version="3.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://lcnetdev.github.io/mods/v3 http://lcnetdev.github.io/standards/mods/v3/mods-3-1.xsd">
