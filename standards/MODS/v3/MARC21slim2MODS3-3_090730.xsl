...
<!-- Maintenance note: 
For each revision, change the content of <recordInfo><recordOrigin> 
to reflect the new revision number.
-->

<!--MARC21slim2MODS3-3.xsl
Revision 1.28 - change mapping from 752,662$g going to mods:hierarchicalGeographic/area instead of "region"
			  - Added <recordInfo><recordOrigin>  canned text about the version of this stylesheet
			  - Added subfields to 300
...
-->
	...
	<xsl:template name="marcRecord">
		...
		<xsl:variable name="physicalDescription">
			...
			<xsl:for-each select="marc:datafield[@tag=300]">
				<extent>
					...
					<!-- <xsl:for-each select="marc:subfield[@code='3' or @code='f']"> (<xsl:value-of select="."/>) </xsl:for-each> -->
				</extent>
			</xsl:for-each>
		</xsl:variable>
		...
		<recordInfo>
			...
			<recordOrigin>Converted from MARCXML to MODS version 3.3 using MARC21slim2MODS3-3.xsl (Revision 1.28)</recordOrigin>
...
<metaInformation>
<scenarios ><scenario default="no" name="Scenario1" userelativepaths="yes" externalpreview="no" url="http://lccn.loc.gov/12037148/marcxml" htmlbaseurl="" outputurl="" processortype="internal" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator=""/><scenario default="yes" name="Scenario2" userelativepaths="yes" externalpreview="no" url="..\..\..\..\temp\marcxml.xml" htmlbaseurl="" outputurl="" processortype="internal" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator=""/></scenarios><MapperMetaTag><MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/><MapperBlockPosition></MapperBlockPosition><TemplateContext></TemplateContext></MapperMetaTag>
</metaInformation>
-->