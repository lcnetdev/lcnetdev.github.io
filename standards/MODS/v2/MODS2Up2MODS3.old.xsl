...
<xsl:stylesheet version="1.0" 
	...
	xmlns="http://www.loc.gov/mods"
		...
		8: place, role, language terms:  role/text
		13:  remove attribute "type" for related Item type "related"
		14: hdl's/identifier??
		15? physical location
		fixes from marc21slim2mods (v2) stylesheet:
			multiple place codes within place
			form/uncontrolled
			partnumber/partname inside title
	-->
	<xsl:template match="/">
		<xsl:choose>
...
<metaInformation>
<scenarios ><scenario default="yes" name="mods2to3" userelativepaths="yes" externalpreview="no" url="modsv2&#x2D;1.xml" htmlbaseurl="" outputurl="..\test_files\modsv3fromv2.xml" processortype="internal" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/><scenario default="no" name="Scenario2" userelativepaths="yes" externalpreview="no" url="testIhasmods.xml" htmlbaseurl="" outputurl="mods2 to 3 testOutput.xml" processortype="internal" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""/></scenarios><MapperInfo srcSchemaPath="" srcSchemaRoot="" srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/>
</metaInformation>
-->